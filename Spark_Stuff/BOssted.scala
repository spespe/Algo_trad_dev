...
boostingStrategy.numIterations = 15 // Note: Use more iterations in practice.
boostingStrategy.treeStrategy.numClassesForClassification = 3
boostingStrategy.treeStrategy.maxDepth = 7
//  Empty categoricalFeaturesInfo indicates all features are continuous.
boostingStrategy.treeStrategy.categoricalFeaturesInfo = Map[Int, Int]( 0-> 24)
